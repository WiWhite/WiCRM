$('#update').on('show.bs.modal', function (event) {
          ...
          modal.find('.modal-body select[name="phone_number_0"]').val(customer_phonenumber.slice(0, 4))
          modal.find('.modal-body input[name="phone_number_1"]').val(customer_phonenumber.slice(4))
